...
async def cmd_clear(bot, message, command, args):
    ...
    is_admin = message.author.guild_permissions.administrator or ds_role in message.author.roles

    is_admin = is_admin or discord.utils.get(message.guild.roles, name="Admin Service") in message.author.roles
