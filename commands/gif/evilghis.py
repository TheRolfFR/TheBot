...
for i in range(0, half_nb_frames):
  ...
  evilGhisGIFCreator.addText(text_properties=caption_text, x=int(ghisGIF.size[0] / 2), y=ghisGIF.size[1] - GHIS_BOTTOM_MARGIN - caption_text.computeSize(d, GHIS_CAPTION)[1], text=GHIS_CAPTION)

async def cmd_evilghis(bot: discord.Client, message: discord.Message, command: str, args):
  """
